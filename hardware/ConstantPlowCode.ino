...
int rCount=2; //change count to move plow more, 2=0.5in
int level=0;
int max=10; //max level of plow
int min=-10; //minimum level of plow
...
void forward(){
  ...
  digitalWrite(enPin23,LOW); //will constantly lift plow throughout movement
  ...
  digitalWrite(ms2Pin23, HIGH); 
  digitalWrite(ms3Pin23, HIGH);
